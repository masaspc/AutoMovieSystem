...
_SCRIPT_TEMPLATE_INSTRUCTIONS: dict[str, str] = {
    ...
    "trivia": "「意外な事実」を次々に紹介する雑学構成にしてください。1つの雑学ごとに"
    "「へえ、そうなんだ」と思わせる意外性→簡潔な理由の順で展開してください。",
    "news_commentary": "話題の出来事を「何が起きたか→なぜ重要か→視聴者への影響」の順で"
    "わかりやすく解説する構成にしてください。事実と意見を明確に区別してください。",
}
