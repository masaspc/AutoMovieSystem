...
_OUTRO_VARIATIONS: tuple[tuple[str, str, str], ...] = (
    ...
    (
        "最後まで完走した記念に、グッドボタンをポチッとしてほしいのだ!",
        "次の学習も一緒に進めたい方は、チャンネル登録をお願いします。",
        "今日試してみたいこともコメントで教えてほしいのだ。また会うのだ!",
    ),
    (
        "この解説をあとで見返したいと思ったら、グッドボタンで応援してほしいのだ!",
        "チャンネル登録と通知をオンにすると、新しい解説を確認しやすくなりますよ。",
        "みんなの疑問も次の題材にしたいのだ。コメントで待ってるのだ〜!",
    ),
    (
        "今日のポイントが一つでも残ったら、グッドボタンをお願いするのだ!",
        "続きも無理なく学べるように作るので、ぜひチャンネル登録してくださいね。",
        "次に知りたいテーマも教えてほしいのだ。それじゃあまたなのだ!",
    ),
    (
        "ここまで学んだ自分に拍手なのだ!ついでにグッドボタンも押してほしいのだ!",
        "この調子で続ける方は、チャンネル登録で次回の動画もチェックしてください。",
        "感想を一言でももらえるとうれしいのだ。次回もよろしくなのだ〜!",
    ),
    (
        "役に立ったところがあったら、グッドボタンで合図してほしいのだ!",
        "これからも分かりやすい動画を届けるので、チャンネル登録をお願いします。",
        "あなたの答えや質問もコメントで聞かせてほしいのだ。また次回なのだ!",
    ),
)
